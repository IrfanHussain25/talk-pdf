...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-screen text-gray-100 bg-gray-900 overflow-hidden">
      {/* Sidebar */}
      <aside
        className={`fixed md:static top-0 left-0 z-20 h-full w-64 bg-gray-800 border-r border-gray-700 p-4 flex flex-col transition-transform duration-300 transform md:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
        <div className="mb-4">
